...
<html lang="en">
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="offer-text">
            <h1>50% OFF</h1>
            <p>Tasty Food <br> On Your Hand</p>
        </div>
    </div>
</header>
    ...
    <!-- Restaurant List -->
	<h3 class="text-center mb-4">Our Featured Restaurants</h3>
	<div class="row">
     <!-- Left column for the restaurant list -->
        <div class="col-md-3">
            <ul class="list-group mb-4 restaurant-list">
				...
				if($restid==0)
					$active=' active';
						...
						echo '<li class="list-group-item' . $active . '" data-restid="0">All</li>';
		                $query = "select * from resturants where state=1 order by id";
                        $result = $db->getData($query);
                        while ($rows = mysqli_fetch_array($result)) {
		                $resid = $rows['id'];
                        ...
                        ?>
						<li class="list-group-item<?php echo $active; ?>" data-restid="<?php echo $resid; ?>"><?php echo $resname; ?></li>
				<?php }?>
            </ul>
        </div>      
            <div class="col-md-9">
    ...
    <div class="container bg-dark mt-5">
        <h2 class="section-title text-center text-white">Restaurants</h2>
    <!-- Carousel -->
			...
			<?php 
                ...
                <div class="card">
                    <div class="media media-2x1 gd-primary">
                      <img class="profile-image" src="<?php echo $imagePath; ?>"> 
                    </div>
                    <div class="card-body">
    ...
    <section class="about-section">
        <div class="container px-4 px-lg-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <h2>How Are We?</h2>
                    <p>Our website addresses the issue of food waste in restaurants. When restaurants don't manage to sell all of their food by the end of the day, they throw away surplus.</p>
                    <p>We sell UNUSED, FRESH, & DELICIOUS meals made of food surplus for about half of their original price!</p>
                </div>
        ...
        $('.restaurant-list').on('click', '.list-group-item', function() {
		 var restid = $(this).data('restid');
		 const a = document.createElement('a');
            a.href = 'index.php?restid=' + restid;
            a.click();
		   });
