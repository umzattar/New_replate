...
<div class="container login-container">
    <div class="login-card  bg-light">
        <h2>Login to Fight Food Waste</h2>
        <p class="tagline">Enjoy fresh meals while saving the planet!</p>
        <form action="userdb.php" method="post" id="login" onsubmit="return checkLogin();">
            ...
            <div class="text-center"><button type="submit" class="btn btn-outline-dark mt-auto">Login</button></div>
			</div>
